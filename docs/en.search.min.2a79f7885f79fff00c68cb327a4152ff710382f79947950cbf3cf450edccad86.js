...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8da0ff281a17d14deab3a4f7598ea072b221211dd4edb49400f12e916cdf745e.js',function(){input.required=false;search();});}
