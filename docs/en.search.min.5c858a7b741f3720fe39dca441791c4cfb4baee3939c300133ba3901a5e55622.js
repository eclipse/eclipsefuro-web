...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a9b1023d0be7dd5bc6eb7d0ab0370508a6466db94d240435ac0651f02f858c47.js',function(){input.required=false;search();});}
