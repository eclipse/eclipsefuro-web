...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.caec5551f046e28a4eea6f2d3a38429aa6b16963d883b64ffb5eaac94adae0d3.js',function(){input.required=false;search();});}
