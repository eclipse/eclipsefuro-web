...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7365d9227b8e8574804e48060cd822dece7133b3d6bd23cedc7ca144f81d7954.js',function(){input.required=false;search();});}
