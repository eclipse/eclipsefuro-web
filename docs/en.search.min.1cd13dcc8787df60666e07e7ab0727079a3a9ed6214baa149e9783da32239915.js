...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.281a952bba5b62cbf8ff925fd991fb931b1ee4fe0642f2f9a0545938452a9df8.js',function(){input.required=false;search();});}
