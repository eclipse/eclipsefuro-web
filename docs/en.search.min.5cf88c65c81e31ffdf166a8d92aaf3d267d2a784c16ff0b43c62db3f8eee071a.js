...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.75448a747619fbd3d7aadd3b15cf42178f86a0269b70b9feae54471e6b956448.js',function(){input.required=false;search();});}
