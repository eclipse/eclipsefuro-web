...
return _furoShell.Theme.getThemeForComponent(this.name)||_furoShell.css`
     ...
     */render(){return _furoShell.html`
            ...
            <furo-markdown unsafe mdsrc="/FuroBaseComponents/_page/markdown/default-icons.md"></furo-markdown>
            <demo-furo-icon-list></demo-furo-icon-list>
            
            <topic-title title="custom icons"></topic-title>
            <furo-markdown mdsrc="/FuroBaseComponents/_page/markdown/custom-icons.md"></furo-markdown>
...
return _furoShell.html`
            ...
            <furo-markdown unsafe mdsrc="/FuroBaseComponents/_page/markdown/styling-top.md"></furo-markdown>
            <style-category-sample></style-category-sample>
            <furo-markdown unsafe mdsrc="/FuroBaseComponents/_page/markdown/styling-bottom.md"></furo-markdown>
        `}}window.customElements.define("page-styling",PageStyling);class PanelMdLoader extends(0,_furoShell.FBP)(_furoShell.LitElement){constructor(){super();this._FBPAddWireHook("--pathChanged",e=>{let md=e.pathSegments[0];this._FBPTriggerWire("--fetchMD","/FuroBaseComponents/_page/markdown/"+md+".md");this.scrollTop=0})}/**
    * flow is ready lifecycle method
    */_FBPReady(){super._FBPReady();//this._FBPTraceWires()
}/**
     * Themable Styles
