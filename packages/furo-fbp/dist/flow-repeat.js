...
export class FlowRepeat extends FBP(HTMLElement) {
    ...
    select(index) {
        if (this._insertedItems[index]) {
            ...
            this._insertedItems[index].virtualElement._FBPTriggerWire('--itemSelected', true);
    ...
    deselect() {
        if (this.selectedIndex !== undefined &&
            ...
            this._insertedItems[this.selectedIndex].virtualElement._FBPTriggerWire('--itemDeSelected', false);
    ...
    injectItems(items) {
        ...
        items.forEach((e, i, a) => {
            ...
            else if (this._insertedItems[i].identity === false ||
    ...
    triggerFirst(data) {
        if (this._insertedItems[0]) {
            ...
            this._insertedItems[0].virtualElement._FBPTriggerWire('--triggerFirst', data);
        }
    }
    /**
    ...
    triggerLast(data) {
        if (this._insertedItems[this._insertedItems.length - 1]) {
            this._insertedItems[this._insertedItems.length - 1].virtualElement._FBPTriggerWire('--trigger', data);
            this._insertedItems[this._insertedItems.length - 1].virtualElement._FBPTriggerWire('--triggerLast', data);
        }
    }
    /**
...
//# sourceMappingURL=flow-repeat.js.map