...
class DemoFuroFormLayouterComplex extends FBP(LitElement) {
    ...
    static get styles() {
        // language=CSS
        return Theme.getThemeForComponent('DemoFuroFormLayouterComplex') || css`
            :host {
                display: block;
            }
    ...
    render() {
        ...
        return html`
            ...
            <furo-demo-snippet>
                <template>
                    <furo-form header-text="Complex form design"
                        ...
                        <furo-form-layouter four>
                            ...
                            <furo-date-input condensed autofocus hint="Only possible in current year" max="2020-12-31" min="2020-01-01"
                                             label="valid from"></furo-date-input>
                            <furo-select-input newline condensed label="Mutation reason on new line" value="New"
                                               list="New, mutation, remake"></furo-select-input>
                            <p full>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
