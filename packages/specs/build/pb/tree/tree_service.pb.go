...
func (*CreateTreeServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_service_bdc0463a56ff4358, []int{0}
}
...
func (*DeleteTreeServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_service_bdc0463a56ff4358, []int{1}
}
...
func (*GetTreeServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_service_bdc0463a56ff4358, []int{2}
}
...
func (*ListTreeServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_service_bdc0463a56ff4358, []int{3}
}
...
func (*UpdateTreeServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_service_bdc0463a56ff4358, []int{4}
}
...
func init() { proto.RegisterFile("tree_service.proto", fileDescriptor_tree_service_bdc0463a56ff4358) }

var fileDescriptor_tree_service_bdc0463a56ff4358 = []byte{
