...
func (*Date) Descriptor() ([]byte, []int) {
	return fileDescriptor_date_caedba0e6cc73af8, []int{0}
}
...
func init() { proto.RegisterFile("date.proto", fileDescriptor_date_caedba0e6cc73af8) }

var fileDescriptor_date_caedba0e6cc73af8 = []byte{
