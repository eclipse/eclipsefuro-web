...
func (*Task) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_fd324bfdbdbb36bd, []int{0}
}
...
func init() { proto.RegisterFile("task.proto", fileDescriptor_task_fd324bfdbdbb36bd) }

var fileDescriptor_task_fd324bfdbdbb36bd = []byte{
