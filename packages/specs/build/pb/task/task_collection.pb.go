...
func (*TaskCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_collection_4a7d6822f6057af6, []int{0}
}
...
func init() {
	proto.RegisterFile("task_collection.proto", fileDescriptor_task_collection_4a7d6822f6057af6)
}

var fileDescriptor_task_collection_4a7d6822f6057af6 = []byte{
