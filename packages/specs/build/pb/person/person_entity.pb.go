...
func (*PersonEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_entity_6d9e7a2acc67431b, []int{0}
}
...
func init() { proto.RegisterFile("person_entity.proto", fileDescriptor_person_entity_6d9e7a2acc67431b) }

var fileDescriptor_person_entity_6d9e7a2acc67431b = []byte{
