...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_link_fea2aab1d23fb907, []int{0}
}
...
func init() { proto.RegisterFile("link.proto", fileDescriptor_link_fea2aab1d23fb907) }

var fileDescriptor_link_fea2aab1d23fb907 = []byte{
