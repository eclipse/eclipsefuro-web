...
func (*Meta) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_223adb9fc7dbe1ff, []int{0}
}
...
func init() { proto.RegisterFile("meta.proto", fileDescriptor_meta_223adb9fc7dbe1ff) }

var fileDescriptor_meta_223adb9fc7dbe1ff = []byte{
