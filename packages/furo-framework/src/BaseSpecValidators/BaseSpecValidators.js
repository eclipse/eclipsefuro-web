...
export class BaseSpecValidators {
  ...
  static registerAll() {
    ...
    ValidatorRegistry.register('google.protobuf.Int32Value', ValidatorGoogleProtobufInt64Value)
    ValidatorRegistry.register('google.protobuf.UInt32Value', ValidatorGoogleProtobufInt64Value)
    ValidatorRegistry.register('google.protobuf.Int64Value', ValidatorGoogleProtobufInt64Value)
    ValidatorRegistry.register('google.protobuf.UInt64Value', ValidatorGoogleProtobufInt64Value)

    ValidatorRegistry.register('google.protobuf.DoubleValue', ValidatorGoogleProtobufFloatValue)
    ValidatorRegistry.register('google.protobuf.FloatValue', ValidatorGoogleProtobufFloatValue)

    ValidatorRegistry.register('furo.BigDecimal', ValidatorFuroBigDecimal)

    ValidatorRegistry.register('google.protobuf.BoolValue', ValidatorGoogleProtobufBoolValue)

    ValidatorRegistry.register('furo.Reference', ValidatorFuroReference)

    ValidatorRegistry.register('google.protobuf.Timestamp', ValidatorGoogleProtobufTimestamp)
  }
}
