 ...
 * @appliesMixin FBP
 */
class DemoFuroTypeRendererCelledit extends FBP(LitElement) {
  /**
   * Themable Styles
   * @private
   * @return {CSSResult}
    ...
    return html`
      <furo-vertical-flex>
        ...
        <furo-form-layouter two>
          <furo-type-renderer context="celledit" ƒ-bind-data="--entity(*.data.display_name)"></furo-type-renderer>
          <furo-type-renderer context="celledit" ƒ-bind-data="--entity(*.data.description)"></furo-type-renderer>
          <furo-type-renderer context="celledit" ƒ-bind-data="--entity(*.data.the_any_type)"></furo-type-renderer>
...
window.customElements.define('demo-furo-type-renderer-celledit', DemoFuroTypeRendererCelledit);
