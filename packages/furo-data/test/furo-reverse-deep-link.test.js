...
describe('furo-reverse-deep-link', () => {
  ...
  it('should convert a Collection', (done) => {
    element._services.ProjectMembersService.services.Unsubscribe.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}.json";
    element._services.ProjectMembersService.services.List.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}.json";
  ...
  it('should return void on unspecified service', () => {
  ...
  it('should convert a Entity', (done) => {
    ...
    element._services.ProjectMembersService.services.Get.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}.json";
    element._services.ProjectMembersService.services.Unsubscribe.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}.json";
    element.convert({
      "data": 32, "links": [{
        "rel": "self",
  ...
  it('should convert a links Array', (done) => {
    ...
    element._services.ProjectMembersService.services.Get = {deeplink: {href: ""}};
    element._services.ProjectMembersService.services.Get.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}.json";
    element._services.ProjectMembersService.services.Unsubscribe.deeplink.href = "/{demo}/api/{version}/tasks/{vtr}:unsubscribe";
