...
export class FieldNode extends EventTreeNode {
        ...
        if (this._meta && !this._meta.readonly) {
            if (this.__childNodes.length > 0) {
                ...
                for (let index in this.__childNodes) {
                    let field = this.__childNodes[index];
                    let val;
                    if (field._constraints && field._constraints.required && field._constraints.required.is === 'true') {
                        val = field._required_value;
                    } else {
    ...
    get _delta_value() {
        ...
        if (this.__childNodes.length > 0) {
            ...
            for (let index in this.__childNodes) {
                let field = this.__childNodes[index];
                let val;
                if (field._constraints !== undefined && field._constraints.required !== undefined && field._constraints.required.is === 'true') {
                    val = field._required_value;
                } else {
     ...
     */
    get _required_value() {
        if ((this._meta && !this._meta.readonly) || (this._constraints !== undefined && this._constraints.required !== undefined && this._constraints.required.is === 'true') || !this._pristine) {
            if (this.__childNodes.length > 0) {
                this.__value = {};
                // nur reine Daten zurück geben
                for (let index in this.__childNodes) {
