    ...
    return html`
      <furo-vertical-flex>
        <div>
          ...
          <p>
            Eclipse Furo Web relies mainly on the web component standard. The JS data modules enable
            seamless integration of any front-end technology without using web components.
          </p>
          <ul>
        ...
        <p>
          ${this.dataModelApi.data.data.first_name} ${this.dataModelApi.data.data.name}<br />
          ${this.dataModelApi.data.data.phone_nr}
        </p>
