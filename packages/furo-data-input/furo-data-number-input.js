 ...
 * @customElement
 * @demo demo/furo-number-input.html
 * @mixes FBP
 * @mixes FuroInputBase
 */
class FuroDataNumberInput extends FBP(FuroInputBase(LitElement)) {
  ...
  render() {
    // language=HTML
    return html`      
      <input id="input" ?autofocus=${this.autofocus} ?disabled=${this.disabled}  type="number" list="datalist" ƒ-.value="--value" @-input="--inputInput(*)"   ƒ-focus="--focusReceived">
