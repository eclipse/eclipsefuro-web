...
describe('furo-data-range-input', () => {
  let dataRangeInput; let host; let dataObject; let secondRangeInput; let invalidRangeInput; let deeplink;
  beforeEach(async () => {
    ...
    host = testbind._host;
    [, dataRangeInput,secondRangeInput, invalidRangeInput,dataObject,deeplink] = testbind.parentNode.children;
