...
describe('furo-data-search-input', () => {
  let dataSearchInput, host, dataObject, secondSearchInput, invalidSearchInput;
  ...
  beforeEach(async () => {
    const testbind = await fixture(html`
      <test-bind>
        ...
        <furo-data-search-input hint="FromTPL" label="FromTPL" ƒ-bind-data="--entity(*.name)"
                              @-value-changed="--searchChanged"></furo-data-search-input>
    ...
    host = testbind._host;
    [, dataObject,dataSearchInput,secondSearchInput,invalidSearchInput] = testbind.parentNode.children;
