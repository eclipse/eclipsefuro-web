...
func request_ProjectMembersService_ListMembers_0(ctx context.Context, marshaler runtime.Marshaler, client ProjectMembersServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterProjectMembersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProjectMembersServiceClient) error {
	...
	mux.Handle("GET", pattern_ProjectMembersService_ListMembers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProjectMembersService_ListMembers_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_ProjectMembersService_ListMembers_0 = runtime.ForwardResponseMessage
