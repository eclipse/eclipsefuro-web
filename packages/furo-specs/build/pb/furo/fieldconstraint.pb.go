...
func (*Fieldconstraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_fieldconstraint_33a23d4a713971ab, []int{0}
}
...
func init() {
	proto.RegisterFile("fieldconstraint.proto", fileDescriptor_fieldconstraint_33a23d4a713971ab)
}

var fileDescriptor_fieldconstraint_33a23d4a713971ab = []byte{
