...
func (*CreateProjectServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_ecd5369ca3f57a03, []int{0}
}
...
func (*DeleteProjectServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_ecd5369ca3f57a03, []int{1}
}
...
func (*GetProjectServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_ecd5369ca3f57a03, []int{2}
}
...
func (*ListProjectServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_ecd5369ca3f57a03, []int{3}
}
...
func (*UpdateProjectServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_service_ecd5369ca3f57a03, []int{4}
}
...
func init() {
	proto.RegisterFile("project_service.proto", fileDescriptor_project_service_ecd5369ca3f57a03)
}

var fileDescriptor_project_service_ecd5369ca3f57a03 = []byte{
