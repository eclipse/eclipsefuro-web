...
func (*PersonCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_collection_1a95bca369fc81af, []int{0}
}
...
func init() {
	proto.RegisterFile("person_collection.proto", fileDescriptor_person_collection_1a95bca369fc81af)
}

var fileDescriptor_person_collection_1a95bca369fc81af = []byte{
