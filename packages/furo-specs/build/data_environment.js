export const Services = {
  "TreeService": {
    ...
    "version": "1.0.0",
    "lifecycle": {"deprecated": false, "info": "This version is still valid"},
    "__proto": {"package": "projectmemberservice", "imports": ["person/person.proto"], "targetfile": "service.proto"},
    "services": {
      "Unsubscribe": {
    ...
    "__proto": {
      ...
      "imports": ["experiment/experiment.proto", "google/protobuf/empty.proto"],
      "targetfile": "service.proto"
    },
    "services": {
      "List": {
...
export const Types = {
  "tree.Tree": {
    ...
    "__proto": {"package": "tree", "imports": [], "targetfile": "tree.proto"},
    "fields": {
  ...
  "tree.TreeEntity": {
    ...
    "__proto": {"package": "tree", "imports": ["furo/meta.proto", "furo/link.proto"], "targetfile": "tree.proto"},
    "fields": {
  ...
  "tree.Navigationnode": {
    ...
    "fields": {
      ...
      "link": {"description": "Deeplink information of this node", "type": "furo.Link", "__proto": {"number": 10}},
      "children": {
  ...
  "person.Person": {
    ...
    "__proto": {"package": "person", "imports": [], "targetfile": "person.proto"},
    "fields": {
      "id": {
  ...
  "person.PersonCollection": {
    ...
    "__proto": {"package": "person", "imports": ["furo/meta.proto", "furo/link.proto"], "targetfile": "person.proto"},
    "fields": {
      "meta": {"description": "Meta for the response", "type": "furo.Meta", "__proto": {"number": 2}},
      "links": {
        "description": "Hateoas links",
  ...
  "project.ProjectCollection": {
    ...
    "__proto": {"package": "project", "imports": ["furo/meta.proto", "furo/link.proto"], "targetfile": "project.proto"},
    "fields": {
      "meta": {"description": "Meta for the response", "type": "furo.Meta", "__proto": {"number": 2}},
      "links": {
        "description": "Hateoas links",
  ...
  "task.Task": {
    ...
    "__proto": {"package": "task", "imports": ["furo/reference.proto"], "targetfile": "task.proto"},
    "fields": {
      "id": {
  ...
  "experiment.Experiment": {
    ...
    "__proto": {"package": "experiment", "imports": ["google/protobuf/any.proto"], "targetfile": "experiment.proto"},
    "fields": {
      "id": {
      ...
      "furo_data_checkbox_input": {
        ...
        "type": "bool",
        "meta": {"label": "checkbox_input", "default": "", "hint": "Hint"},
      ...
      "furo_data_text_input": {
        ...
        "type": "string",
        "meta": {"label": "text_input", "hint": "hint", "readonly": false},
      ...
      "furo_data_textarea_input": {
        ...
        "type": "string",
        "meta": {"label": "textarea_input", "hint": "hint"},
        "constraints": {"readonly": false},
        "options": [],
        "__proto": {"number": 6}
      },
      "furo_data_time_input": {
        ...
        "type": "string",
        "meta": {"label": "time-input", "hint": "hint"},
        "constraints": {"readonly": false, "min": null, "max": null, "step": ""},
        "options": [],
        "__proto": {"number": 7}
      },
      "furo_data_range_input": {
        ...
        "type": "string",
        "meta": {"label": "range-input", "hint": "hint"},
        "constraints": {"min": null, "max": null, "step": "", "readonly": false},
        "options": [],
        "__proto": {"number": 8}
      },
      "furo_data_number_input": {
        ...
        "type": "float",
        "meta": {"label": "number-input", "hint": "hint"},
        "constraints": {"min": 1, "max": 5, "step": "", "readonly": false},
        "options": [],
        "__proto": {"number": 9}
      },
      "furo_data_color_input": {
        ...
        "type": "string",
        "meta": {"label": "color-input", "hint": "hint"},
        "constraints": {"readonly": false},
        "options": [],
        "__proto": {"number": 10}
      },
      "furo_data_password_input": {
        ...
        "type": "string",
        "meta": {"label": "password-input", "hint": "hint"},
        "constraints": {"min": 6, "max": 15, "pattern": "", "readonly": false},
        "options": [],
        "__proto": {"number": 11}
      },
      "furo_data_search_input": {
        ...
        "type": "string",
        "meta": {"label": " search", "hint": "hint"},
        "constraints": {"min": 1, "max": 15, "pattern": "", "readonly": false},
        "options": [],
        "__proto": {"number": 12}
      },
      "furo_data_date_input": {
        ...
        "type": "string",
        "meta": {"label": "date-input", "hint": "hint"},
        "constraints": {"min": 1, "max": 15, "pattern": "", "readonly": false},
        "options": [],
        "__proto": {"number": 13}
      },
      "furo_data_bool_icon": {
        ...
        "type": "bool",
        "meta": {"label": "bool-icon input", "hint": "hint"},
        "constraints": {"readonly": false},
        "options": [],
        "__proto": {"number": 14}
      },
      "the_any_type": {
        ...
        "meta": {"label": "can be anything", "hint": "hint"},
        "constraints": {"readonly": false},
        "options": [],
        "__proto": {"number": 15}
      }
  ...
  "furo.Reference": {
    ...
    "__proto": {"package": "furo", "imports": [], "targetfile": "reference.proto"},
    "fields": {
      "display_name": {
  ...
  "furo.Metafield": {
    ...
    "fields": {
      "meta": {"description": "meta information of a field", "type": "Fieldmeta", "__proto": {"number": 3}},
      "constraints": {
  ...
  "furo.Meta": {
    ...
    "fields": {
      "meta": {
        "description": "fields of meta info",
        "type": "keyValuePair",
        "__proto": {"number": 1, "map_from": "string", "map_to": "Metafield"}
      }
    }
  },
  "furo.Link": {
