export const Services = {
  'TreeService': {
    ...
    '__proto': {
      ...
      'options': { 'go_package': '/treeservice' },
    },
    'services': {
      'List': {
  ...
  'ProjectfilterService': {
    ...
    '__proto': {
      ...
      'imports': ['projectfilter/projectfilter.proto', 'google/protobuf/empty.proto'],
      'targetfile': 'projectfilterservice.proto',
      'options': { 'go_package': '/projectfilterservice' },
    },
    'services': {
      'Get': {
        ...
        'data': { 'request': null, 'response': 'projectfilter.ProjectfilterEntity' },
        'query': {},
        'deeplink': { 'rel': 'self', 'href': '/mockdata/projects/filter/get.json', 'method': 'GET' },
      },
    },
  },
  'AuthService': {
    ...
    '__proto': {
      ...
      'options': { 'go_package': '/authservice' },
    },
    'services': {
      'List': {
      ...
      'Create': {
        ...
        'query': {},
        'deeplink': { 'rel': 'create', 'href': '/api/auths', 'method': 'POST' },
      },
      'Get': {
        ...
        'query': {},
        'deeplink': { 'rel': 'self', 'href': '/api/auths/{uid}', 'method': 'GET' },
      },
      'Update': {
        ...
        'data': { 'request': 'auth.Auth', 'response': 'auth.AuthEntity' },
        'query': {},
        'deeplink': { 'rel': 'update', 'href': '/api/auths/{uid}', 'method': 'PATCH' },
      },
      'Delete': {
  ...
  'PersonService': {
    ...
    '__proto': {
      ...
      'targetfile': 'service.proto',
      'options': { 'go_package': '/personservice' },
    },
    'services': {
      'List': {
  ...
  'ProjectService': {
    ...
    '__proto': {
      ...
      'targetfile': 'service.proto',
      'options': { 'go_package': '/projectservice' },
    },
    'services': {
      'List': {
  ...
  'ProjectMembersService': {
    ...
    '__proto': {
      ...
      'targetfile': 'service.proto',
      'options': { 'go_package': '/projectmemberservice' },
    },
    'services': {
      'Unsubscribe': {
  ...
  'TaskService': {
    ...
    '__proto': {
      ...
      'targetfile': 'service.proto',
      'options': { 'go_package': '/taskservice' },
    },
    'services': {
      'List': {
        ...
        'query': {
          ...
          'view': {
            ...
            'type': 'string',
            'meta': { 'label': 'View', 'hint': 'Should be a enum type. MUST be named view' },
            '__proto': { 'type': 'string' },
          },
        },
        'deeplink': {
  ...
  'ExperimentService': {
    ...
    '__proto': {
      ...
      'targetfile': 'service.proto',
      'options': { 'go_package': '/experimentservice' },
    },
    'services': {
      'List': {
      ...
      'Release': {
        ...
        'data': { 'request': 'experiment.ExperimentEntity', 'response': 'google.protobuf.Empty' },
        'query': {},
        'deeplink': { 'rel': 'release', 'href': '/mockdata/experiments/1:release', 'method': 'POST' },
      },
      'CreateTemplate': {
        'description': 'create an experiment template',
        'rpc_name': 'CreateTemplateExperiment',
        'data': { 'request': 'google.protobuf.Empty', 'response': 'experiment.Experiment' },
        'query': {},
        'deeplink': { 'rel': 'createtemplate', 'href': '/mockdata/experiments:createtemplate', 'method': 'POST' },
      },
    },
  },
};
export const Types = {
  ...
  'projectfilter.ProjectfilterEntity': {
  ...
  'projectfilter.Projectfilter': {
    ...
    '__proto': {
      'package': 'projectfilter',
      'options': {},
      'imports': ['google/type/date.proto', 'google/type/money.proto', 'furo/reference.proto'],
      'targetfile': 'projectfilter.proto',
    },
    'fields': {
      'description': {
  ...
  'projectfilter.ProjectfilterCollection': {
  ...
  'person.Person': {
    ...
    '__proto': {
      'package': 'person',
      'imports': ['google/protobuf/types/known/field_mask.proto'],
  ...
  'project.Project': {
    ...
    '__proto': {
      'package': 'project',
      'imports': ['google/protobuf/types/known/field_mask.proto', 'google/type/money.proto', 'google/type/date.proto', 'person/person.proto'],
      'targetfile': 'project.proto',
    },
    'fields': {
      'id': {
      ...
      'cost_limit': {
        ...
        '__ui': { 'component': '', 'flags': ['align-right'] },
        '__proto': { 'number': 7 },
      },
      'update_mask': {
        'description': 'Contains a field_mask which fields of the targeted resource are going to be updated',
  ...
  'menu.Menuitem': {
    ...
    '__proto': {
      'package': 'menu',
      'options': { 'java_outer_classname': 'MenuApi', 'java_package': 'com.acme.menu' },
      'imports': ['google/protobuf/any.proto'],
      'targetfile': 'menu.proto',
    },
    'fields': {
      'icon': { 'description': 'Leading icon of the menu', 'type': 'string', '__proto': { 'number': 1 } },
      'display_name': {
      ...
      'command': { 'description': 'Keyboard command hint', 'type': 'string', 'meta': {}, '__proto': { 'number': 4 } },
      'action': {
      ...
      'flags': {
        ...
        'type': 'string',
        'meta': { 'readonly': true, 'repeated': true },
        '__proto': { 'number': 8 },
      },
      'payload': {
  ...
  'task.Task': {
    ...
    'fields': {
      ...
      'description': {
        ...
        'type': 'string',
        'meta': { 'label': 'task.desc.label', 'default': '', 'hint': '' },
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
  ...
  'experiment.Constraints': {
    ...
    '__proto': {
      'package': 'experiment',
      'imports': ['google/protobuf/any.proto', 'google/type/date.proto', 'google/type/money.proto'],
      'targetfile': 'experiment.proto',
    },
    'fields': {
      'id': {
      ...
      'display_name': {
        ...
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'pattern': { 'is': '^a.*', 'message': 'must start with a' },
          'max': { 'is': '12', 'message': 'maximal 12' },
        },
        '__proto': { 'number': 2 },
      },
      'number': {
        ...
        'type': 'int32',
        'meta': { 'label': 'Valid values are 6,9,12', 'default': 1, 'hint': '' },
        'constraints': {
          'min': { 'is': '6', 'message': 'Minimal number 6' },
          'max': { 'is': '12', 'message': 'maximal 12' },
          'step': { 'is': '3', 'message': 'step 3' },
        },
        '__proto': { 'number': 3 },
      },
      'text': {
        'description': 'Localized String representation of a experiment',
        'type': 'string',
        'meta': { 'label': 'experiment', 'default': '', 'hint': '', 'readonly': false },
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'pattern': { 'is': '^a.*', 'message': 'must start with a' },
          'min': { 'is': '6', 'message': 'minimal 6' },
          'max': { 'is': '12', 'message': 'maximal 12' },
        },
        '__proto': { 'number': 4 },
      },
      'date': {
        ...
        'type': 'google.type.Date',
        'meta': { 'label': 'Date', 'default': '', 'hint': '', 'readonly': false },
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'min': { 'is': '2020-01-01', 'message': 'min 01.01.2020' },
          'max': { 'is': '9999-12-31', 'message': 'max 31.12.9999' },
          'step': { 'is': '30', 'message': 'step 30 days' },
        },
        '__proto': { 'number': 5 },
      },
      'money': {
        ...
        'type': 'google.type.Money',
        'meta': { 'label': 'Money', 'default': { 'currency': 'CHF' }, 'hint': '', 'readonly': false },
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'min': { 'is': '1200.50', 'message': 'min amount 1200.50' },
          'max': { 'is': '100000.00', 'message': 'max amount 100000.00' },
          'step': { 'is': '1000.00', 'message': 'only in steps of 1000' },
        },
        '__proto': { 'number': 6 },
      },
    },
  ...
  'experiment.Experiment': {
    ...
    '__proto': {
      'package': 'experiment',
      'imports': ['google/protobuf/any.proto', 'google/type/date.proto', 'google/type/money.proto', 'google/protobuf/types/known/field_mask.proto', 'furo/property.proto'],
      'targetfile': 'experiment.proto',
    },
    'fields': {
      'id': {
      ...
      'description': {
        'description': 'Short experiment description',
        'type': 'string',
        'meta': { 'label': 'Description', 'default': 'Default Description', 'hint': '' },
        'constraints': {},
        '__proto': { 'number': 3 },
      },
      'furo_data_checkbox_input': {
        ...
        'type': 'bool',
        'meta': { 'label': 'checkbox_input', 'default': '', 'hint': 'Hint', 'readonly': false },
        'constraints': {},
        '__proto': { 'number': 4 },
      },
      'furo_data_text_input': {
        ...
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'min': { 'is': 3, 'message': 'at least 3 characters' },
          'max': { 'is': 15, 'message': '15 characters maximum' },
          'pattern': { 'is': '^a.*', 'message': 'must start with a' },
        },
        '__proto': { 'number': 5 },
      },
      'furo_data_textarea_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'textarea_input', 'hint': 'hint', 'readonly': false, 'rows': 3, 'cols': 100 },
        'constraints': {},
        '__proto': { 'number': 6 },
      },
      'furo_data_time_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'time-input', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': '05:00', 'message': 'From 05:00' },
          'max': { 'is': '19:00', 'message': 'to 19:00' },
          'step': { 'is': '5', 'message': 'step 5' },
        },
        '__proto': { 'number': 7 },
      },
      'furo_data_range_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'range-input', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': 20, 'message': 'From 20' },
          'max': { 'is': 50, 'message': 'to 50' },
          'step': { 'is': '2.5', 'message': 'step 2.5' },
        },
        '__proto': { 'number': 8 },
      },
      'furo_data_number_input': {
        ...
        'type': 'float',
        'meta': { 'label': 'number-input', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': 1, 'message': 'from 1' },
          'max': { 'is': 555, 'message': 'to 555' },
          'step': { 'is': '3', 'message': 'step 3' },
        },
        '__proto': { 'number': 9 },
      },
      'furo_data_color_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'color-input', 'hint': 'hint', 'readonly': false },
        'constraints': {},
        '__proto': { 'number': 10 },
      },
      'furo_data_password_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'password-input', 'hint': 'hint', 'readonly': false },
        'constraints': { 'min': { 'is': 6, 'message': 'min 6' }, 'max': { 'is': 15, 'message': 'max 15' } },
        '__proto': { 'number': 11 },
      },
      'furo_data_search_input': {
        'description': 'field for furo-search-input for testing',
        'type': 'string',
        'meta': { 'label': ' search', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': 1, 'message': 'min 1' },
          'max': { 'is': 15, 'message': 'max 15' },
          'pattern': { 'is': 'a.*', 'message': 'must start with a' },
        },
        '__proto': { 'number': 12 },
      },
      'furo_data_date_input': {
        ...
        'type': 'string',
        'meta': { 'label': 'date-input', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': '1800-01-01', 'message': 'The earliest date to accept is 1800-01-01' },
          'max': { 'is': '2099-12-31', 'message': 'The latest date to accept is 2099-12-31' },
          'step': { 'is': '5', 'message': 'step 5' },
        },
        '__proto': { 'number': 13 },
      },
      'furo_data_bool_icon': {
        ...
        'type': 'bool',
        'meta': { 'label': 'bool-icon input', 'hint': 'hint', 'readonly': false },
        'constraints': {},
        '__proto': { 'number': 14 },
      },
      'the_any_type': {
        ...
        'type': 'google.protobuf.Any',
        'meta': { 'label': 'can be anything', 'hint': 'hint', 'readonly': false },
        'constraints': {},
        '__proto': { 'number': 15 },
      },
      'type_with_options': {
      ...
      'type_property': {
        ...
        'type': 'furo.Property',
        'meta': { 'label': 'Additional fields', 'repeated': true },
        'constraints': {},
        '__proto': { 'number': 17 },
      },
      'furo_data_date_input_google': {
        'description': 'field for furo-data-date-input for testing',
        'type': 'google.type.Date',
        'meta': { 'label': 'gogole-date-input', 'hint': 'hint', 'readonly': false },
        'constraints': {
          'min': { 'is': '1800-01-01', 'message': 'The earliest date to accept is 1800-01-01' },
          'max': { 'is': '2099-12-31', 'message': 'The latest date to accept is 2099-12-31' },
          'step': { 'is': '2', 'message': 'step 2' },
        },
        '__proto': { 'number': 18 },
      },
      ...
      'repstring': {
        ...
        'type': 'string',
        'meta': { 'repeated': true, 'label': 'Description', 'default': 'Ein text per default', 'hint': '' },
        'constraints': {},
        '__proto': { 'number': 20 },
      },
      'furo_data_money_input': {
        ...
        'constraints': {
          'required': { 'is': 'true', 'message': 'is required' },
          'min': { 'is': 0, 'message': 'amount can not be negative' },
          'max': { 'is': 999999, 'message': 'amount maximal 999999' },
          'step': { 'is': 0.01, 'message': 'step 0.01' },
        },
        '__proto': { 'number': 21 },
      },
      'furo_data_file_input': {
        ...
        'type': 'string',
        'meta': { 'readonly': false, 'repeated': true, 'label': 'Choose a file' },
        'constraints': { 'required': { 'is': 'true', 'message': 'is required' } },
        '__proto': { 'number': 22 },
      },
      'update_mask': {
  ...
  'experiment.Default': {
    ...
    'fields': {
      ...
      'description': {
        'description': 'Short experiment description',
        'type': 'string',
        'meta': { 'label': 'Description', 'default': 'Ein text per default', 'hint': '' },
        'constraints': {},
        '__proto': { 'number': 3 },
      },
      'repstring': {
  ...
  'experiment.Readonly': {
    ...
    '__proto': {
      'package': 'experiment',
      'targetfile': 'experiment.proto',
      'imports': ['furo/property.proto', 'project/project.proto'],
      'options': null,
    },
    'fields': {
      'project': {
  ...
  'experiment.Recursive': {
    ...
    '__proto': {
      'package': 'experiment',
      'imports': ['google/protobuf/any.proto', 'google/type/date.proto'],
      'targetfile': 'experiment.proto',
    },
    'fields': {
      'id': {
        ...
        'type': 'string',
        'meta': { 'label': 'Id', 'default': '', 'hint': '', 'readonly': false },
        'constraints': {},
        '__proto': { 'number': 1 },
      },
      'display_name': {
  ...
  'experiment.Oneof': {
    ...
    '__proto': {
      'package': 'experiment',
      'imports': ['google/protobuf/any.proto', 'google/type/date.proto', 'google/type/money.proto', 'google/protobuf/field_mask.proto', 'furo/property.proto', 'enum/corpus.enum.proto'],
      'targetfile': 'experiment.proto',
    },
    'fields': {
      'id': {
      ...
      'update_mask': {
        ...
        'meta': {},
        'constraints': {},
        '__proto': { 'number': 23, 'oneof': 'complex' },
      },
      'other_mask': {
        ...
        'meta': {},
        'constraints': {},
        '__proto': { 'number': 24, 'oneof': 'complex' },
      },
      'value': {
        ...
        'meta': {},
        'constraints': {},
        '__proto': { 'number': 25, 'oneof': 'complex' },
      },
      'cor': {
        'description': 'skalar in a group of complex',
        'type': 'enum.Corpus',
        'meta': {},
        'constraints': {},
        '__proto': { 'number': 29, 'oneof': 'complex' },
      },
    },
  },
  'furo.Reference': {
  ...
  'furo.fat.Int64': {
    ...
    '__proto': { 'package': 'furo.fat', 'targetfile': 'fat.proto', 'imports': [], 'options': {} },
    'fields': {
      'value': {
        'type': 'int64',
        ...
        'constraints': {
          'min': { 'is': '-9007199254740991', 'message': 'out of range' },
          'max': { 'is': '9007199254740991', 'message': 'out of range' },
        },
      },
      'labels': {
        'type': 'string',
  ...
  'furo.fat.Uint32': {
    ...
    'fields': {
      'value': {
        ...
        'constraints': {
          'min': { 'is': '0', 'message': 'out of range' },
          'max': { 'is': '4294967295', 'message': 'out of range' },
        },
      },
      'labels': {
        'type': 'string',
  ...
  'furo.Property': {
    ...
    '__proto': { 'package': 'furo', 'imports': ['google/protobuf/any.proto'], 'targetfile': 'property.proto' },
    'fields': {
      'id': {
      ...
      'code': { 'description': 'property code for additional settings', 'type': 'string', '__proto': { 'number': 5 } },
      'flags': {
  ...
  'google.protobuf.types.known.FieldMask': {
    'name': 'field_mask',
    'type': 'FieldMask',
  ...
  'google.protobuf.Int64Value': {
    'name': 'int64value',
    'type': 'Int64Value',
    'description': 'Wrapper message for `int64`.  https://github.com/protocolbuffers/protobuf/blob/master/src/google/protobuf/wrappers.proto',
    '__proto': { 'package': 'google.protobuf', 'options': {}, 'imports': [], 'targetfile': 'wrappers.proto' },
    'fields': {
      'value': {
  ...
  'enum.Corpus': {
    ...
    '__proto': { 'package': 'enum', 'options': {}, 'targetfile': 'corpus.enum.proto', 'allow_alias': true },
    'values': { 'UNKNOWN': 0, 'STARTED': 1, 'RUNNING': 1, 'COMPLETE': 2 },
    'type': 'Corpus',
  },
  'enum.Secondenum': {
    'name': 'Secondenum',
    'description': 'enum sample with aliases which should be in corpus.enum.proto',
    '__proto': { 'package': 'enum', 'options': {}, 'targetfile': 'corpus.enum.proto', 'allow_alias': false },
    'values': { 'DEFAULT': 0, 'YOURS': 1, 'THEIRS': 2 },
    'type': 'Secondenum',
  },
};
