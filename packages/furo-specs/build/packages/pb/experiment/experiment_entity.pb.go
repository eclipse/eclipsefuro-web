...
func (*ExperimentEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_experiment_entity_f4b2f2b23c2472af, []int{0}
}
...
func init() {
	proto.RegisterFile("experiment_entity.proto", fileDescriptor_experiment_entity_f4b2f2b23c2472af)
}

var fileDescriptor_experiment_entity_f4b2f2b23c2472af = []byte{
