...
func (*ExperimentEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_experiment_entity_e862e89bb800cfce, []int{0}
}
...
func init() {
	proto.RegisterFile("experiment_entity.proto", fileDescriptor_experiment_entity_e862e89bb800cfce)
}

var fileDescriptor_experiment_entity_e862e89bb800cfce = []byte{
