...
func (*CreateExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_d77b395edc47cd1d, []int{0}
}
...
func (*DeleteExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_d77b395edc47cd1d, []int{1}
}
...
func (*GetExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_d77b395edc47cd1d, []int{2}
}
...
func (*ListExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_d77b395edc47cd1d, []int{3}
}
...
func (*UpdateExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_d77b395edc47cd1d, []int{4}
}
...
func init() {
	proto.RegisterFile("ExperimentService.proto", fileDescriptor_ExperimentService_d77b395edc47cd1d)
}

var fileDescriptor_ExperimentService_d77b395edc47cd1d = []byte{
