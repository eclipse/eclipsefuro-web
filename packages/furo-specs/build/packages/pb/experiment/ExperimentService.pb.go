...
func (*CreateExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_cafa7c98a1668942, []int{0}
}
...
func (*DeleteExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_cafa7c98a1668942, []int{1}
}
...
func (*GetExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_cafa7c98a1668942, []int{2}
}
...
func (*ListExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_cafa7c98a1668942, []int{3}
}
...
func (*UpdateExperimentServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ExperimentService_cafa7c98a1668942, []int{4}
}
...
func init() {
	proto.RegisterFile("ExperimentService.proto", fileDescriptor_ExperimentService_cafa7c98a1668942)
}

var fileDescriptor_ExperimentService_cafa7c98a1668942 = []byte{
