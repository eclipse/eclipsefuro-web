...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_2590fcd27446310d, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_2590fcd27446310d)
}

var fileDescriptor_project_collection_2590fcd27446310d = []byte{
