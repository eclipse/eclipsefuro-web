...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_31799dc5cbc4353a, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_31799dc5cbc4353a)
}

var fileDescriptor_project_collection_31799dc5cbc4353a = []byte{
