...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_c7825c6effad71cc, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_c7825c6effad71cc)
}

var fileDescriptor_project_collection_c7825c6effad71cc = []byte{
