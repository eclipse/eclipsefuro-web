...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_bc00aba263a056a2, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_bc00aba263a056a2)
}

var fileDescriptor_project_collection_bc00aba263a056a2 = []byte{
