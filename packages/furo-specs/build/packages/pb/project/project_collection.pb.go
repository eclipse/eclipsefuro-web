...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_ed612a4229725359, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_ed612a4229725359)
}

var fileDescriptor_project_collection_ed612a4229725359 = []byte{
