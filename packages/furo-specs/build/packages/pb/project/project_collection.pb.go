...
func (*ProjectCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_collection_0a9097bc7b265208, []int{0}
}
...
func init() {
	proto.RegisterFile("project_collection.proto", fileDescriptor_project_collection_0a9097bc7b265208)
}

var fileDescriptor_project_collection_0a9097bc7b265208 = []byte{
