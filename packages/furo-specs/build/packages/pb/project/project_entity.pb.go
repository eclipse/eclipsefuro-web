...
func (*ProjectEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_entity_dede6cf201758553, []int{0}
}
...
func init() {
	proto.RegisterFile("project_entity.proto", fileDescriptor_project_entity_dede6cf201758553)
}

var fileDescriptor_project_entity_dede6cf201758553 = []byte{
