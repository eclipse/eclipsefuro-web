...
func (*ProjectEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_project_entity_2dddecac79c532a5, []int{0}
}
...
func init() {
	proto.RegisterFile("project_entity.proto", fileDescriptor_project_entity_2dddecac79c532a5)
}

var fileDescriptor_project_entity_2dddecac79c532a5 = []byte{
