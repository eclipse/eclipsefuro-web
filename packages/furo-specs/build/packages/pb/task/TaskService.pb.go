...
func (*CreateTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_51975a368fc617f0, []int{0}
}
...
func (*DeleteTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_51975a368fc617f0, []int{1}
}
...
func (*GetTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_51975a368fc617f0, []int{2}
}
...
func (*ListTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_51975a368fc617f0, []int{3}
}
...
func (*UpdateTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_51975a368fc617f0, []int{4}
}
...
func init() { proto.RegisterFile("TaskService.proto", fileDescriptor_TaskService_51975a368fc617f0) }

var fileDescriptor_TaskService_51975a368fc617f0 = []byte{
