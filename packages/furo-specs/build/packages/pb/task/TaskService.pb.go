...
func (*CreateTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_1e0c93fdd7eb3f24, []int{0}
}
...
func (*DeleteTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_1e0c93fdd7eb3f24, []int{1}
}
...
func (*GetTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_1e0c93fdd7eb3f24, []int{2}
}
...
func (*ListTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_1e0c93fdd7eb3f24, []int{3}
}
...
func (*UpdateTaskServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_TaskService_1e0c93fdd7eb3f24, []int{4}
}
...
func init() { proto.RegisterFile("TaskService.proto", fileDescriptor_TaskService_1e0c93fdd7eb3f24) }

var fileDescriptor_TaskService_1e0c93fdd7eb3f24 = []byte{
