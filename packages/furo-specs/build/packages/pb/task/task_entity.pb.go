...
func (*TaskEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_entity_b1e2a7472235a6e8, []int{0}
}
...
func init() { proto.RegisterFile("task_entity.proto", fileDescriptor_task_entity_b1e2a7472235a6e8) }

var fileDescriptor_task_entity_b1e2a7472235a6e8 = []byte{
