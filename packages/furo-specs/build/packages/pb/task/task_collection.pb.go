...
func (*TaskCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_collection_f1d784cd5fe830e2, []int{0}
}
...
func init() {
	proto.RegisterFile("task_collection.proto", fileDescriptor_task_collection_f1d784cd5fe830e2)
}

var fileDescriptor_task_collection_f1d784cd5fe830e2 = []byte{
