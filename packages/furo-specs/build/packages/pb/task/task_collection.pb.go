...
func (*TaskCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_collection_e6e9ff3642330cfc, []int{0}
}
...
func init() {
	proto.RegisterFile("task_collection.proto", fileDescriptor_task_collection_e6e9ff3642330cfc)
}

var fileDescriptor_task_collection_e6e9ff3642330cfc = []byte{
