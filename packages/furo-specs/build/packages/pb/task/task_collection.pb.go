...
func (*TaskCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_collection_f96e663c996472fd, []int{0}
}
...
func init() {
	proto.RegisterFile("task_collection.proto", fileDescriptor_task_collection_f96e663c996472fd)
}

var fileDescriptor_task_collection_f96e663c996472fd = []byte{
