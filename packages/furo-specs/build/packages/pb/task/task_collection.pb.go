...
func (*TaskCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_task_collection_7da8b11664b1e6ec, []int{0}
}
...
func init() {
	proto.RegisterFile("task_collection.proto", fileDescriptor_task_collection_7da8b11664b1e6ec)
}

var fileDescriptor_task_collection_7da8b11664b1e6ec = []byte{
