...
func (*PersonEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_entity_18bcce04cd972ca0, []int{0}
}
...
func init() { proto.RegisterFile("person_entity.proto", fileDescriptor_person_entity_18bcce04cd972ca0) }

var fileDescriptor_person_entity_18bcce04cd972ca0 = []byte{
