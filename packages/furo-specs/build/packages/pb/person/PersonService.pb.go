...
func (*CreatePersonServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_PersonService_cc15c0e561aa83f2, []int{0}
}
...
func (*DeletePersonServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_PersonService_cc15c0e561aa83f2, []int{1}
}
...
func (*GetPersonServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_PersonService_cc15c0e561aa83f2, []int{2}
}
...
func (*ListPersonServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_PersonService_cc15c0e561aa83f2, []int{3}
}
...
func (*UpdatePersonServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_PersonService_cc15c0e561aa83f2, []int{4}
}
...
func init() { proto.RegisterFile("PersonService.proto", fileDescriptor_PersonService_cc15c0e561aa83f2) }

var fileDescriptor_PersonService_cc15c0e561aa83f2 = []byte{
