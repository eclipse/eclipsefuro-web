...
func (*PersonCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_collection_b7ccf47651e02516, []int{0}
}
...
func init() {
	proto.RegisterFile("person_collection.proto", fileDescriptor_person_collection_b7ccf47651e02516)
}

var fileDescriptor_person_collection_b7ccf47651e02516 = []byte{
