...
func (*PersonCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_collection_4398d1ce07f39464, []int{0}
}
...
func init() {
	proto.RegisterFile("person_collection.proto", fileDescriptor_person_collection_4398d1ce07f39464)
}

var fileDescriptor_person_collection_4398d1ce07f39464 = []byte{
