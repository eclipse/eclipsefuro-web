...
func (*TreeCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_collection_86ea5a3dd6561323, []int{0}
}
...
func init() {
	proto.RegisterFile("tree_collection.proto", fileDescriptor_tree_collection_86ea5a3dd6561323)
}

var fileDescriptor_tree_collection_86ea5a3dd6561323 = []byte{
