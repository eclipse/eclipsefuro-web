...
func (*TreeCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_collection_097e88b5d58839e7, []int{0}
}
...
func init() {
	proto.RegisterFile("tree_collection.proto", fileDescriptor_tree_collection_097e88b5d58839e7)
}

var fileDescriptor_tree_collection_097e88b5d58839e7 = []byte{
