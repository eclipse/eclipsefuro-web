...
func (*TreeCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_collection_8a5a5b4aad9f4aff, []int{0}
}
...
func init() {
	proto.RegisterFile("tree_collection.proto", fileDescriptor_tree_collection_8a5a5b4aad9f4aff)
}

var fileDescriptor_tree_collection_8a5a5b4aad9f4aff = []byte{
