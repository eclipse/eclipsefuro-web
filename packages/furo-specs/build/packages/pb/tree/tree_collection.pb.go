...
func (*TreeCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_collection_a23a7e0cd52b8405, []int{0}
}
...
func init() {
	proto.RegisterFile("tree_collection.proto", fileDescriptor_tree_collection_a23a7e0cd52b8405)
}

var fileDescriptor_tree_collection_a23a7e0cd52b8405 = []byte{
