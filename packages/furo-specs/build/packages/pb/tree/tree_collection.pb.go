...
func (*TreeCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_tree_collection_3879e5a94d14e4bb, []int{0}
}
...
func init() {
	proto.RegisterFile("tree_collection.proto", fileDescriptor_tree_collection_3879e5a94d14e4bb)
}

var fileDescriptor_tree_collection_3879e5a94d14e4bb = []byte{
