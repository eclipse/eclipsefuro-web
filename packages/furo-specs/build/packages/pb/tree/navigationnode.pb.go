...
func (*Navigationnode) Descriptor() ([]byte, []int) {
	return fileDescriptor_navigationnode_2eaf79cd32ae9dca, []int{0}
}
...
func init() {
	proto.RegisterFile("navigationnode.proto", fileDescriptor_navigationnode_2eaf79cd32ae9dca)
}

var fileDescriptor_navigationnode_2eaf79cd32ae9dca = []byte{
