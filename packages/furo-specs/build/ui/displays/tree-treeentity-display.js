...
/**
 * `tree-treeentity-display`
 * TreeEntity with Tree
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TreeTreeEntityDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('tree-treeentity-display', TreeTreeEntityDisplay);
