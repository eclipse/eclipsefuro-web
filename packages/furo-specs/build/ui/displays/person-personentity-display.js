...
/**
 * `person-personentity-display`
 * PersonEntity with Person
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonEntityDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personentity-display', PersonPersonEntityDisplay);
