...
/**
 * `project-projectentity-display`
 * ProjectEntity with Project
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ProjectProjectEntityDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('project-projectentity-display', ProjectProjectEntityDisplay);
