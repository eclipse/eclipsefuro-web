...
/**
 * `task-taskcollection-display`
 * TaskCollection with repeated TaskEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TaskTaskCollectionDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('task-taskcollection-display', TaskTaskCollectionDisplay);
