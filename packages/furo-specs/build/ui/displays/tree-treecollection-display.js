...
/**
 * `tree-treecollection-display`
 * TreeCollection with repeated TreeEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TreeTreeCollectionDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('tree-treecollection-display', TreeTreeCollectionDisplay);
