...
/**
 * `experiment-experimententity-display`
 * ExperimentEntity with Experiment
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ExperimentExperimentEntityDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
    ...
    render() {
        ...
        return html`
            ...
            <furo-form-layouter four>
                ...
                <furo-data-display condensed double noborder ƒ-bind-data="--data(*.data)"></furo-data-display>
                <!-- Hateoas links  -->
...
window.customElements.define('experiment-experimententity-display', ExperimentExperimentEntityDisplay);
