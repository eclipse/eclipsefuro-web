...
/**
 * `person-personcollection-display`
 * PersonCollection with repeated PersonEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonCollectionDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personcollection-display', PersonPersonCollectionDisplay);
