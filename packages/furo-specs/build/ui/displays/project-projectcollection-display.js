...
/**
 * `project-projectcollection-display`
 * ProjectCollection with repeated ProjectEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ProjectProjectCollectionDisplay extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('project-projectcollection-display', ProjectProjectCollectionDisplay);
