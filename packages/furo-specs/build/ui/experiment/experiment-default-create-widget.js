...
/**
 * `experiment-default-create-widget`
 * Test the default value
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ExperimentDefaultCreateWidget extends FBP(LitElement) {
    /**
...
window.customElements.define('experiment-default-create-widget', ExperimentDefaultCreateWidget);
