    ...
    render() {
        ...
        return html`
            ...
            <furo-form-layouter four>
                ...
                <furo-data-display condensed double noborder ƒ-bind-data="--data(*.type_property)"></furo-data-display>
                <!-- field for furo-data-date-input for testing  -->
                <furo-data-display condensed double noborder ƒ-bind-data="--data(*.furo_data_date_input_google)"></furo-data-display>
                <!-- field for testing property  -->
                <furo-data-display condensed double noborder ƒ-bind-data="--data(*.single_type_property)"></furo-data-display>
            </furo-form-layouter>
