...
/**
 * `person-personcollection-form`
 * PersonCollection with repeated PersonEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonCollectionForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personcollection-form', PersonPersonCollectionForm);
