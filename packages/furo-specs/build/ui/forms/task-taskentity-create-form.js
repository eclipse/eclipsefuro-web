...
/**
 * `task-taskentity-create-form`
 * TaskEntity with Task
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TaskTaskEntityCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('task-taskentity-create-form', TaskTaskEntityCreateForm);
