...
/**
 * `experiment-experimentcollection-create-form`
 * ExperimentCollection with repeated ExperimentEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ExperimentExperimentCollectionCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('experiment-experimentcollection-create-form', ExperimentExperimentCollectionCreateForm);
