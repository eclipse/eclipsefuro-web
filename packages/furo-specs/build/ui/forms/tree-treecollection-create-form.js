...
/**
 * `tree-treecollection-create-form`
 * TreeCollection with repeated TreeEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TreeTreeCollectionCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('tree-treecollection-create-form', TreeTreeCollectionCreateForm);
