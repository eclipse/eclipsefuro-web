...
/**
 * `experiment-experimententity-form`
 * ExperimentEntity with Experiment
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ExperimentExperimentEntityForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('experiment-experimententity-form', ExperimentExperimentEntityForm);
