...
/**
 * `experiment-experimentcollection-form`
 * ExperimentCollection with repeated ExperimentEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ExperimentExperimentCollectionForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('experiment-experimentcollection-form', ExperimentExperimentCollectionForm);
