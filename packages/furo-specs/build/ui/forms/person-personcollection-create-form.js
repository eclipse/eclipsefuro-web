...
/**
 * `person-personcollection-create-form`
 * PersonCollection with repeated PersonEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonCollectionCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personcollection-create-form', PersonPersonCollectionCreateForm);
