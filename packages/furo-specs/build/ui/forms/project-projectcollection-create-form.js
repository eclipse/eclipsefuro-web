...
/**
 * `project-projectcollection-create-form`
 * ProjectCollection with repeated ProjectEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ProjectProjectCollectionCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('project-projectcollection-create-form', ProjectProjectCollectionCreateForm);
