...
/**
 * `person-personentity-create-form`
 * PersonEntity with Person
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonEntityCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personentity-create-form', PersonPersonEntityCreateForm);
