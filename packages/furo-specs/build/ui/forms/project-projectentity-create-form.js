...
/**
 * `project-projectentity-create-form`
 * ProjectEntity with Project
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ProjectProjectEntityCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('project-projectentity-create-form', ProjectProjectEntityCreateForm);
