...
/**
 * `person-personentity-form`
 * PersonEntity with Person
 *
 * @customElement
 * @appliesMixin FBP
 */
export class PersonPersonEntityForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('person-personentity-form', PersonPersonEntityForm);
