...
/**
 * `task-taskcollection-form`
 * TaskCollection with repeated TaskEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TaskTaskCollectionForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('task-taskcollection-form', TaskTaskCollectionForm);
