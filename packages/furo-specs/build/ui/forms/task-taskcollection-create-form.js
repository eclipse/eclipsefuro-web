...
/**
 * `task-taskcollection-create-form`
 * TaskCollection with repeated TaskEntity
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TaskTaskCollectionCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('task-taskcollection-create-form', TaskTaskCollectionCreateForm);
