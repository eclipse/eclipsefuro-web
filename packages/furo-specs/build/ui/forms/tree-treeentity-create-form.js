...
/**
 * `tree-treeentity-create-form`
 * TreeEntity with Tree
 *
 * @customElement
 * @appliesMixin FBP
 */
export class TreeTreeEntityCreateForm extends FBP(LitElement) {
    static get styles() {
        // language=CSS
...
window.customElements.define('tree-treeentity-create-form', TreeTreeEntityCreateForm);
