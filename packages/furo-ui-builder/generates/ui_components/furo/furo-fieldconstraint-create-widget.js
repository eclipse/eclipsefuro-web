 ...
 * @appliesMixin FBP
 */
export class FuroFieldconstraintCreateWidget extends FBP(LitElement) {
...
window.customElements.define('furo-fieldconstraint-create-widget', FuroFieldconstraintCreateWidget);
