 ...
 * @appliesMixin FBP
 */
export class FuroStringoptionpropertyCreateForm extends FBP(LitElement) {
...
window.customElements.define('furo-stringoptionproperty-create-form', FuroStringoptionpropertyCreateForm);
