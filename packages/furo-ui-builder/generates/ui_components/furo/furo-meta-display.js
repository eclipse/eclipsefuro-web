 ...
 * @appliesMixin FBP
 */
export class FuroMetaDisplay extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: fields -->
          <furo-data-display condensed double ƒ-bind-data="--data(*.fields)" ƒ-focus="--focused"></furo-data-display> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
...
window.customElements.define('furo-meta-display', FuroMetaDisplay);
