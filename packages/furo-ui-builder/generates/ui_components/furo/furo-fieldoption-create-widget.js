 ...
 * @appliesMixin FBP
 */
export class FuroFieldoptionCreateWidget extends FBP(LitElement) {
...
window.customElements.define('furo-fieldoption-create-widget', FuroFieldoptionCreateWidget);
