 ...
 * @appliesMixin FBP
 */
export class FuroIntegerpropertyCreateForm extends FBP(LitElement) {
...
window.customElements.define('furo-integerproperty-create-form', FuroIntegerpropertyCreateForm);
