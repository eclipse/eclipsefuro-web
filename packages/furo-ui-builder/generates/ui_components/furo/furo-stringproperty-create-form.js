 ...
 * @appliesMixin FBP
 */
export class FuroStringpropertyCreateForm extends FBP(LitElement) {
...
window.customElements.define('furo-stringproperty-create-form', FuroStringpropertyCreateForm);
