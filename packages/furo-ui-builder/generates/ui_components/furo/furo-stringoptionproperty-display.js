 ...
 * @appliesMixin FBP
 */
export class FuroStringoptionpropertyDisplay extends FBP(LitElement) {
...
window.customElements.define('furo-stringoptionproperty-display', FuroStringoptionpropertyDisplay);
