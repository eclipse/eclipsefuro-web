 ...
 * @appliesMixin FBP
 */
export class FuroStringoptionpropertyForm extends FBP(LitElement) {
...
window.customElements.define('furo-stringoptionproperty-form', FuroStringoptionpropertyForm);
