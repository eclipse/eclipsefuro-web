 ...
 * @appliesMixin FBP
 */
export class FuroIntegerpropertyCreateWidget extends FBP(LitElement) {
...
window.customElements.define('furo-integerproperty-create-widget', FuroIntegerpropertyCreateWidget);
