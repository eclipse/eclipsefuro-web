 ...
 * @appliesMixin FBP
 */
export class FuroBigdecimalRepeat extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-data-repeat delete-icon="delete" repeated-component="furo-bigdecimal-form" ƒ-add="--adderTriggered" ƒ-bind-data="--data"></furo-data-repeat>
      ...
      <furo-horizontal-flex>
        ...
        <!-- It is a good practice to set a description -->
        <furo-button outline label="Add BigDecimal" @-click="--adderTriggered"></furo-button>
      </furo-horizontal-flex>
    `;
  }
}

window.customElements.define('furo-bigdecimal-repeat', FuroBigdecimalRepeat);
