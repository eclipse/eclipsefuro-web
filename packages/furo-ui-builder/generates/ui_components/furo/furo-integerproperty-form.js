 ...
 * @appliesMixin FBP
 */
export class FuroIntegerpropertyForm extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: data -->
          <furo-data-number-input condensed double ƒ-bind-data="--data(*.data)" ƒ-focus="--focused"></furo-data-number-input> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
...
window.customElements.define('furo-integerproperty-form', FuroIntegerpropertyForm);
