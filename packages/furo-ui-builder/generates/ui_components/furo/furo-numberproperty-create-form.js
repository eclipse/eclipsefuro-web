 ...
 * @appliesMixin FBP
 */
export class FuroNumberpropertyCreateForm extends FBP(LitElement) {
...
window.customElements.define('furo-numberproperty-create-form', FuroNumberpropertyCreateForm);
