 ...
 * @appliesMixin FBP
 */
export class FuroFieldconstraintCreateForm extends FBP(LitElement) {
...
window.customElements.define('furo-fieldconstraint-create-form', FuroFieldconstraintCreateForm);
