 ...
 * @appliesMixin FBP
 */
export class FuroStringpropertyCreateWidget extends FBP(LitElement) {
...
window.customElements.define('furo-stringproperty-create-widget', FuroStringpropertyCreateWidget);
