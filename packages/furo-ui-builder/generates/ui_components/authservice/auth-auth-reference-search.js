 ...
 * @appliesMixin FBP
 */
export class AuthAuthReferenceSearch extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <!-- It is a good practice to set a description -->
      <furo-collection-agent service="AuthService" @-response="--collection" ƒ-hts-in="--field-injected(*.link._value), --htsUpdated" ƒ-search="--debouncedTerm"></furo-collection-agent> 
    `;
  }
}

window.customElements.define('auth-auth-reference-search', AuthAuthReferenceSearch);
