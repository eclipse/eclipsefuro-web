...
export class PersonPersonReferenceDropdown extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <!-- It is a good practice to set a description -->
      <furo-collection-agent list-on-hts-in service="ProjectMembersService" @-response="--collection" ƒ-hts-in="--field-injected(*.link._value), --htsUpdated"></furo-collection-agent> 
    `;
  }
}
