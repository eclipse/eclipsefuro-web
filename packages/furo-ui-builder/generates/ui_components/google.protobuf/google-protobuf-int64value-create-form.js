 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt64valueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-int64value-create-form', GoogleProtobufInt64valueCreateForm);
