 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufStringvalueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-stringvalue-form', GoogleProtobufStringvalueForm);
