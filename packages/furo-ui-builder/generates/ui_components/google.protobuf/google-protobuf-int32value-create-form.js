 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt32valueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-int32value-create-form', GoogleProtobufInt32valueCreateForm);
