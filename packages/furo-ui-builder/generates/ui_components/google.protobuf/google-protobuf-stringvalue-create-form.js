 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufStringvalueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-stringvalue-create-form', GoogleProtobufStringvalueCreateForm);
