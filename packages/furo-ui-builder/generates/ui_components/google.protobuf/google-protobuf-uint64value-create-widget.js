 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint64valueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint64value-create-widget', GoogleProtobufUint64valueCreateWidget);
