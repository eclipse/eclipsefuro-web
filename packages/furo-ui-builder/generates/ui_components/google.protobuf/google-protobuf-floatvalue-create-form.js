 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFloatvalueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-floatvalue-create-form', GoogleProtobufFloatvalueCreateForm);
