 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFieldmaskCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-fieldmask-create-form', GoogleProtobufFieldmaskCreateForm);
