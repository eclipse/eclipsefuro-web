 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint32valueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint32value-create-form', GoogleProtobufUint32valueCreateForm);
