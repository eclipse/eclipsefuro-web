 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufDoublevalueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-doublevalue-create-widget', GoogleProtobufDoublevalueCreateWidget);
