 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt32valueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-int32value-display', GoogleProtobufInt32valueDisplay);
