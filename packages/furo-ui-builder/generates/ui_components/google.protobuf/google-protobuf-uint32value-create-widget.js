 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint32valueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint32value-create-widget', GoogleProtobufUint32valueCreateWidget);
