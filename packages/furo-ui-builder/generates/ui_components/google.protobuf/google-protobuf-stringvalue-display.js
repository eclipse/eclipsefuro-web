 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufStringvalueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-stringvalue-display', GoogleProtobufStringvalueDisplay);
