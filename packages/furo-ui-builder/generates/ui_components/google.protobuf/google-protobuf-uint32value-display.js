 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint32valueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint32value-display', GoogleProtobufUint32valueDisplay);
