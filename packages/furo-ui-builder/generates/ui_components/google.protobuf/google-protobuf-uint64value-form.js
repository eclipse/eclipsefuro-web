 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint64valueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint64value-form', GoogleProtobufUint64valueForm);
