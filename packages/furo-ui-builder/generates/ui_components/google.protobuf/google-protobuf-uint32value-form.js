 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint32valueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint32value-form', GoogleProtobufUint32valueForm);
