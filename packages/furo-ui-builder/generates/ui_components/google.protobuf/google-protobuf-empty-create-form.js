 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufEmptyCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-empty-create-form', GoogleProtobufEmptyCreateForm);
