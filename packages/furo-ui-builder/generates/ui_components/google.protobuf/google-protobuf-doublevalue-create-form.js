 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufDoublevalueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-doublevalue-create-form', GoogleProtobufDoublevalueCreateForm);
