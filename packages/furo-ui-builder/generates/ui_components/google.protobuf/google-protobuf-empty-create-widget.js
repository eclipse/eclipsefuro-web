 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufEmptyCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-empty-create-widget', GoogleProtobufEmptyCreateWidget);
