 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBoolvalueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-boolvalue-create-widget', GoogleProtobufBoolvalueCreateWidget);
