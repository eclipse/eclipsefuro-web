 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBytesvalueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-bytesvalue-display', GoogleProtobufBytesvalueDisplay);
