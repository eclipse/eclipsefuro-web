 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBytesvalueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-bytesvalue-create-form', GoogleProtobufBytesvalueCreateForm);
