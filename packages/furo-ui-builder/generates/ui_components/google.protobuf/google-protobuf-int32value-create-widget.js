 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt32valueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-int32value-create-widget', GoogleProtobufInt32valueCreateWidget);
