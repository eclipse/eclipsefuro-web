 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufAnyCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-any-create-form', GoogleProtobufAnyCreateForm);
