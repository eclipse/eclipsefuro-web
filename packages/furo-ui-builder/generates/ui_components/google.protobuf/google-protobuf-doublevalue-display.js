 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufDoublevalueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-doublevalue-display', GoogleProtobufDoublevalueDisplay);
