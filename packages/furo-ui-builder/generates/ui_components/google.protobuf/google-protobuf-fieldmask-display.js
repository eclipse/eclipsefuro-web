 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFieldmaskDisplay extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: paths -->
          <furo-data-display condensed double ƒ-bind-data="--data(*.paths)" ƒ-focus="--focused"></furo-data-display> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
...
window.customElements.define('google-protobuf-fieldmask-display', GoogleProtobufFieldmaskDisplay);
