 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBytesvalueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-bytesvalue-create-widget', GoogleProtobufBytesvalueCreateWidget);
