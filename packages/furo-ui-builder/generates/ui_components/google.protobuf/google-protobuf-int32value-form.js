 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufInt32valueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-int32value-form', GoogleProtobufInt32valueForm);
