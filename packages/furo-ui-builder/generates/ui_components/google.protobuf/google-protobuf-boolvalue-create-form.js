 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBoolvalueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-boolvalue-create-form', GoogleProtobufBoolvalueCreateForm);
