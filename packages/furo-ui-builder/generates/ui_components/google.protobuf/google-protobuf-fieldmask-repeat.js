 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFieldmaskRepeat extends FBP(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <furo-data-repeat delete-icon="delete" repeated-component="google-protobuf-fieldmask-form" ƒ-add="--adderTriggered" ƒ-bind-data="--data"></furo-data-repeat>
      ...
      <furo-horizontal-flex>
        ...
        <!-- It is a good practice to set a description -->
        <furo-button outline label="Add FieldMask" @-click="--adderTriggered"></furo-button>
      </furo-horizontal-flex>
    `;
  }
}

window.customElements.define('google-protobuf-fieldmask-repeat', GoogleProtobufFieldmaskRepeat);
