 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufStringvalueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-stringvalue-create-widget', GoogleProtobufStringvalueCreateWidget);
