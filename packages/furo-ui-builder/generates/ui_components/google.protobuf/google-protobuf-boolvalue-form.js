 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBoolvalueForm extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: value -->
          <furo-data-checkbox-input condensed double ƒ-bind-data="--data(*.value)" ƒ-focus="--focused"></furo-data-checkbox-input> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
...
window.customElements.define('google-protobuf-boolvalue-form', GoogleProtobufBoolvalueForm);
