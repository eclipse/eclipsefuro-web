 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFloatvalueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-floatvalue-form', GoogleProtobufFloatvalueForm);
