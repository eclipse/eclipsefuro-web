 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBoolvalueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-boolvalue-display', GoogleProtobufBoolvalueDisplay);
