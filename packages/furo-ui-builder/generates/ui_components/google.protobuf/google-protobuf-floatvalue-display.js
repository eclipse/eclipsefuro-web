 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFloatvalueDisplay extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-floatvalue-display', GoogleProtobufFloatvalueDisplay);
