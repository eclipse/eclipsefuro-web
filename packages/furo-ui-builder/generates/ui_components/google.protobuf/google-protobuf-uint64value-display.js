 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint64valueDisplay extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-form header-text="${this.headerText?this.headerText:""}" secondary-text="${this.secondaryText?this.secondaryText:""}">
        ...
        <furo-form-layouter four>
          ...
          <!-- field: value -->
          <furo-data-display condensed double ƒ-bind-data="--data(*.value)" ƒ-focus="--focused"></furo-data-display> 
        </furo-form-layouter> 
      </furo-form> 
    `;
  }
...
window.customElements.define('google-protobuf-uint64value-display', GoogleProtobufUint64valueDisplay);
