 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufBytesvalueForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-bytesvalue-form', GoogleProtobufBytesvalueForm);
