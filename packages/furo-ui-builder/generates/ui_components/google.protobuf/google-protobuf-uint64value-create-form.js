 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufUint64valueCreateForm extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-uint64value-create-form', GoogleProtobufUint64valueCreateForm);
