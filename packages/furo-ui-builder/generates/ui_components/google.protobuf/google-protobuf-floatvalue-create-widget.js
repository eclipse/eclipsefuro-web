 ...
 * @appliesMixin FBP
 */
export class GoogleProtobufFloatvalueCreateWidget extends FBP(LitElement) {
...
window.customElements.define('google-protobuf-floatvalue-create-widget', GoogleProtobufFloatvalueCreateWidget);
