 ...
 * @appliesMixin FBP
 */
export class ExperimentReadonlyCreateForm extends FBP(LitElement) {
...
window.customElements.define('experiment-readonly-create-form', ExperimentReadonlyCreateForm);
