 ...
 * @appliesMixin FBP
 */
export class ExperimentConstraintsCreateWidget extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-card>
        ...
        <furo-form-layouter>
          ...
          <!-- field: text -->
          <furo-data-text-input condensed ƒ-bind-data="--data(*.text)" ƒ-focus="--focused"></furo-data-text-input> 
        </furo-form-layouter> 
...
window.customElements.define('experiment-constraints-create-widget', ExperimentConstraintsCreateWidget);
