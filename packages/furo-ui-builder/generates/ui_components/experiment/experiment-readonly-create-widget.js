 ...
 * @appliesMixin FBP
 */
export class ExperimentReadonlyCreateWidget extends FBP(LitElement) {
...
window.customElements.define('experiment-readonly-create-widget', ExperimentReadonlyCreateWidget);
