    ...
    return html`
      ...
      <furo-vertical-flex>
        ...
        <furo-panel no-margin>
          ...
          <task-task-update-action @-delete-req="--deleteReq" @-reset-req="--resetReq" @-self-req="--selfReq" @-update-req="--updateReq" ƒ-bind-entity="--entity" ƒ-disable-all="--requestStarted" ƒ-enable-all="--response, --responseError"></task-task-update-action> 
        </furo-panel> 
      </furo-vertical-flex> 
      ...
      <!-- Agent for the service TaskService -->
      <furo-entity-agent load-on-hts-in service="TaskService" @-fatal-error="--error, ^^activity-stopped" @-request-started="--requestStarted, ^^activity-started" @-response="--response, ^^activity-stopped" @-response-error="--error, ^^activity-stopped" ƒ-bind-request-data="--entity(*.data)" ƒ-delete="--deleteReq" ƒ-hts-in="--navNode(*._value.link), --htsIn" ƒ-load="--selfReq" ƒ-put="--updateReq"></furo-entity-agent> 

      <!-- DAO for type task.TaskEntity -->
      <furo-data-object type="task.TaskEntity" @-object-ready="--entity" ƒ-inject-raw="--response" ƒ-reset="--resetReq"></furo-data-object> 
    `;
  }
}
