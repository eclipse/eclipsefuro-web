...
/**
 * `projectfilter-projectfilter-create-widget`
 * Options for possible filter values
 *
 * @customElement
 * @appliesMixin FBP
 */
export class ProjectfilterProjectfilterCreateWidget extends FBP(LitElement) {
    /**
...
window.customElements.define('projectfilter-projectfilter-create-widget', ProjectfilterProjectfilterCreateWidget);
