 ...
 * @customElement
 * @demo demo-component-panel
 * @appliesMixin FBP
 */
class ComponentPanel extends FBP(LitElement) {
  constructor() {
    super();
    /**
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('ComponentPanel') ||
      css`
        :host {
          display: block;
  ...
  render() {
    ...
    return html`
      ...
      <furo-doc-element ƒ-print="--content"></furo-doc-element>
    `;
  }
}

window.customElements.define('component-panel', ComponentPanel);
