 ...
 *
 * @fires {string} trailing-icon-clicked -  Fired when the trailing icon was clicked with the value of the input field. This event bubbles.
 * @fires {string} leading-icon-clicked -  Fired when the leading icon was clicked with the value of the input field. This event bubbles.
