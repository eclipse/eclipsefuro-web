...
class FuroButtonPlayground extends FBP(LitElement) {
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('FuroButtonPlayground') || [
        css`
          :host {
            display: block;
            height: 100%;
        ...
        <div class="flex">
          <furo-split-view>
            <furo-vertical-flex slot="master">
              ...
              <furo-select-input
                label="Theme Color"
                list="none, primary, secondary, accent, danger"
                @-value-changed="--colorset"
              ></furo-select-input>
              <furo-select-input
                label="Border / Fill"
                list="none, raised, unelevated, outline"
                @-value-changed="--layout"
              ></furo-select-input>
