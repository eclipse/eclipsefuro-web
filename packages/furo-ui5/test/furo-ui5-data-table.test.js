...
describe('furo-ui5-data-table', () => {
  ...
  it('should bind to a RepeaterNode', done => {
    ...
    dao.addEventListener('data-injected', () => {
      ...
      setTimeout(() => {
        assert.equal(table.shadowRoot.querySelectorAll('furo-ui5-table-row')[0].children[0].children[0].tagName, 'DISPLAY-STRING')
        assert.equal(table.shadowRoot.querySelectorAll('furo-ui5-table-row')[0].children[1].children[0].tagName, 'DISPLAY-STRING')
        assert.equal(table.shadowRoot.querySelectorAll('furo-ui5-table-row')[0].children[2].children[0].tagName, 'DISPLAY-GOOGLE-TYPE-MONEY')
        assert.equal(table.shadowRoot.querySelectorAll('furo-ui5-table-row')[0].children[3].children[0].tagName, 'DISPLAY-GOOGLE-TYPE-DATE')
