  ...
  beforeEach(async () => {
    const testbind = await fixture(html`
      <test-bind>
        <template>
          <furo-ui5-radiogroup>
            <furo-ui5-data-radio-button name="Group1" ƒ-bind-data="--data(*.furo_data_checkbox_input)"></furo-ui5-data-radio-button>
            <furo-ui5-data-radio-button name="Group1" ƒ-bind-data="--data(*.furo_data_bool_icon)"></furo-ui5-data-radio-button>
          </furo-ui5-radiogroup>
