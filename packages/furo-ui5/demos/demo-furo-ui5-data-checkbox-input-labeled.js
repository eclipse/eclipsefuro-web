...
/**
 * `demo-furo-ui5-data-checkbox-input-labeled`
 *
 * @Summary basic usage of furo-ui5-data-checkbox-input-labeled
 * @customElement
 * @appliesMixin FBP
 */
class DemoFuroUi5DataCheckboxInputLabeled extends FBP(LitElement) {
  /**
   * Themable Styles
   * @private
   * @return {CSSResult}
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('DemoFuroUi5DataCheckboxInputLabeled') ||
      css`
        :host {
          display: block;
          height: 100%;
  ...
  render() {
    ...
    return html`
      <h2>
        Basic usage of furo-ui5-data-checkbox-input-labeled
      </h2>
      ...
      <furo-demo-snippet>
        <template>
          <furo-form-layouter two>
            ...
            >
            <p full>
              Label will be showed on the left side of the checkbox as label. The information text
              on the right side of the checkbox can be set via placeholder.
            </p>
            <furo-ui5-data-checkbox-input-labeled
              required
              placeholder="Additional checkbox ._meta.placeholder"
...
window.customElements.define(
  'demo-furo-ui5-data-checkbox-input-labeled',
  DemoFuroUi5DataCheckboxInputLabeled,
);
