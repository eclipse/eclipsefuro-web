...
/**
 * `demo-furo-ui5-data-money-input-labeled`
 *
 * @Summary basic usage of furo-ui5-data-money-input-labeled
 * @customElement
 * @appliesMixin FBP
 */
class DemoFuroUi5DataMoneyInputLabeled extends FBP(LitElement) {
  /**
   * Themable Styles
   * @private
   * @return {CSSResult}
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('DemoFuroUi5DataMoneyInputLabeled') ||
      css`
        :host {
          display: block;
          height: 100%;
  ...
  render() {
    ...
    return html`
      <h2>
        Basic usage of furo-ui5-data-money-input-labeled
      </h2>
...
window.customElements.define(
  'demo-furo-ui5-data-money-input-labeled',
  DemoFuroUi5DataMoneyInputLabeled,
);
