...
/**
 * `demo-furo-ui5-data-date-time-picker-labeled`
 *
 * @Summary basic usage of furo-ui5-data-text-input-labeled
 * @customElement
 * @appliesMixin FBP
 */
class DemoFuroUi5DataDateTimePickerLabeled extends FBP(LitElement) {
  /**
   * Themable Styles
   * @private
   * @return {CSSResult}
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('DemoFuroUi5DataDateTimePickerLabeled') ||
      css`
        :host {
          display: block;
          height: 100%;
...
window.customElements.define(
  'demo-furo-ui5-data-date-time-picker-labeled',
  DemoFuroUi5DataDateTimePickerLabeled,
);
