    ...
    return html`
      <furo-vertical-flex>
        <div>
          ...
          <p>The <strong>ƒ-bind-nav-node</strong> method accepts a data object with the tree.Navigationnode signature.</p>
        ...
        <furo-demo-snippet flex>
          <template>
            <furo-vertical-scroller>
              ...
              <furo-data-object
                type="tree.Navigationnode" @-object-ready="--Navnode"></furo-data-object>
            </furo-vertical-scroller>
          </template>
        </furo-demo-snippet>
      </furo-vertical-flex>
