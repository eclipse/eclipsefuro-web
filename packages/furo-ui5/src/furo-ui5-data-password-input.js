 ...
 * @demo demo-furo-ui5-data-text-input Usage with different types (scalar , fat, wrapper values)
...
export class FuroUi5DataPasswordInput extends FuroUi5DataInput {
  ...
  /**
   * Fired when the value of the furo-ui5-data-password-input changes at each keystroke, and when a suggestion item has been selected.
   * @event input
   */
...
window.customElements.define('furo-ui5-data-password-input', FuroUi5DataPasswordInput);
