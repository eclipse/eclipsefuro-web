 ...
 * @customElement
 * @demo demo-furo-ui5-data-time-picker-labeled Basic Usage
 * @appliesMixin FBP
 */
export class FuroUi5DataTimePickerLabeled extends FBP(LitElement) {
  constructor() {
    super();
    this.label = '';
  }
  ...
  static get styles() {
    // language=CSS
    return (
      Theme.getThemeForComponent('FuroUi5DataTimePickerLabeled') ||
      css`
        :host {
          display: block;
        }
