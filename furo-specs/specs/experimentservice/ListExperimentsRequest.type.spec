...
description: request message for ListExperiments
lifecycle: null
__proto:
...
fields:
    body:
        ...
        meta:
            default: ""
            placeholder: experimentservice.listexperimentsrequest.body.placeholder
            hint: ""
            label: experimentservice.listexperimentsrequest.body.label
            options:
                flags: []
                list: []
            readonly: false
